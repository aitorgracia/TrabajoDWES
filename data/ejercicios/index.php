...
<body>
  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        <li>
        <a href="/ejercicio<?php printf("%01d", ++$ejercicio);  ?>.php" target="_blank">Ejercicio <?php printf("%02d", $ejercicio);  ?></a>
    ...
    <a href="/ejemplos/<?php printf("%02d", ++$ejemplo);  ?>/" target="_blank">Ejemplo <?php printf("%02d", $ejemplo);  ?></a>
      ...
      <ul>
        <li>
          <a href="/ejercicio<?php printf("%01d", ++$ejercicio);  ?>/" target="_blank">Ejercicio <?php printf("%02d", $ejercicio);  ?></a>
